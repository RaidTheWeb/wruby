...
void GENERATED_TMP__mruby_metaprog_gem_test(state *mrb);
void GENERATED_TMP__mruby_time_gem_test(state *mrb);
void GENERATED_TMP__mruby_io_gem_test(state *mrb);
void GENERATED_TMP__mruby_pack_gem_test(state *mrb);
void GENERATED_TMP__mruby_sprintf_gem_test(state *mrb);
void GENERATED_TMP__mruby_print_gem_test(state *mrb);
void GENERATED_TMP__mruby_math_gem_test(state *mrb);
void GENERATED_TMP__mruby_struct_gem_test(state *mrb);
void GENERATED_TMP__mruby_compar_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_enum_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_fiber_gem_test(state *mrb);
void GENERATED_TMP__mruby_enumerator_gem_test(state *mrb);
void GENERATED_TMP__mruby_string_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_numeric_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_array_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_hash_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_range_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_proc_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_symbol_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_random_gem_test(state *mrb);
void GENERATED_TMP__mruby_object_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_objectspace_gem_test(state *mrb);
void GENERATED_TMP__mruby_enum_lazy_gem_test(state *mrb);
void GENERATED_TMP__mruby_toplevel_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_compiler_gem_test(state *mrb);
void GENERATED_TMP__mruby_bin_mirb_gem_test(state *mrb);
void GENERATED_TMP__mruby_error_gem_test(state *mrb);
void GENERATED_TMP__mruby_bin_mruby_gem_test(state *mrb);
void GENERATED_TMP__mruby_bin_strip_gem_test(state *mrb);
void GENERATED_TMP__mruby_kernel_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_class_ext_gem_test(state *mrb);
void GENERATED_TMP__mruby_test_gem_test(state *mrb);
void mrbgemtest_init(state* mrb) {
