...
/* add -DUSE_FLOAT to use float instead of double for floating point numbers */
//#define USE_FLOAT

/* exclude floating point numbers */
//#define WITHOUT_FLOAT

/* add -DMETHOD_CACHE to use method cache to improve performance */
//#define METHOD_CACHE
/* size of the method cache (need to be the power of 2) */
//#define METHOD_CACHE_SIZE (1<<7)

/* add -DMETHOD_TABLE_INLINE to reduce the size of method table */
...
/* add -DINT16 to use 16bit integer for int; conflict with INT64 */
//#define INT16

/* add -DINT64 to use 64bit integer for int; conflict with INT16 */
//#define INT64
