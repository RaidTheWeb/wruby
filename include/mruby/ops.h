...
OPCODE(LOADI,      BB)       /* R(a) = $int(b) */
OPCODE(LOADINEG,   BB)       /* R(a) = $int(-b) */
OPCODE(LOADI__1,   B)        /* R(a) = $int(-1) */
OPCODE(LOADI_0,    B)        /* R(a) = $int(0) */
OPCODE(LOADI_1,    B)        /* R(a) = $int(1) */
OPCODE(LOADI_2,    B)        /* R(a) = $int(2) */
OPCODE(LOADI_3,    B)        /* R(a) = $int(3) */
OPCODE(LOADI_4,    B)        /* R(a) = $int(4) */
OPCODE(LOADI_5,    B)        /* R(a) = $int(5) */
OPCODE(LOADI_6,    B)        /* R(a) = $int(6) */
OPCODE(LOADI_7,    B)        /* R(a) = $int(7) */
