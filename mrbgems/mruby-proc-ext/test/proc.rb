...
assert('_proc_new_cfunc_with_env') do
  ProcExtTest._proc_new_cfunc_with_env(:test)
  ProcExtTest._proc_new_cfunc_with_env(:mruby)
...
assert('_cfunc_env_get') do
  ProcExtTest._cfunc_env_get :get_int, [0, 1, 2]
